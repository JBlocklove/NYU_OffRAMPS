...
create_clock -period 10.000 -name i_CLK -waveform {0.000 5.000} -add [get_ports sysclk]

##LEDs
set_property -dict {PACKAGE_PIN T14 IOSTANDARD LVCMOS25} [get_ports led_0]
set_property -dict {PACKAGE_PIN T15 IOSTANDARD LVCMOS25} [get_ports led_1]
...
set_property -dict {PACKAGE_PIN W15 IOSTANDARD LVCMOS25} [get_ports led0_g]
set_property -dict {PACKAGE_PIN Y13 IOSTANDARD LVCMOS25} [get_ports led0_r]
...
set_property -dict {PACKAGE_PIN C22 IOSTANDARD LVCMOS33} [get_ports i_btn0]
set_property -dict {PACKAGE_PIN D14 IOSTANDARD LVCMOS33} [get_ports i_btn1]
...
##Pmod header JA
set_property -dict {PACKAGE_PIN AB22 IOSTANDARD LVCMOS33} [get_ports o_UART_RX]
...
set_property -dict {PACKAGE_PIN N19 IOSTANDARD LVCMOS33} [get_ports i_Y_MIN]
#set_property -dict { PACKAGE_PIN N18   IOSTANDARD LVCMOS33 } [get_ports { fmc_la_p[03] }]; #IO_L17P_T2_A26_15 Sch=fmc_la_p[03]
set_property -dict {PACKAGE_PIN M20 IOSTANDARD LVCMOS33} [get_ports i_X_MAX]
set_property -dict {PACKAGE_PIN N20 IOSTANDARD LVCMOS33} [get_ports i_X_MIN]
set_property -dict {PACKAGE_PIN L21 IOSTANDARD LVCMOS33} [get_ports i_Z_MAX]
set_property -dict {PACKAGE_PIN M21 IOSTANDARD LVCMOS33} [get_ports i_Y_MAX]
#set_property -dict { PACKAGE_PIN M22   IOSTANDARD LVCMOS33 } [get_ports { o_E1_STEP }]; #IO_L15N_T2_DQS_ADV_B_15 Sch=fmc_la_n[06]
#set_property -dict { PACKAGE_PIN N22   IOSTANDARD LVCMOS33 } [get_ports { o_E1_DIR }]; #IO_L15P_T2_DQS_15 Sch=fmc_la_p[06]
#set_property -dict { PACKAGE_PIN L13   IOSTANDARD LVCMOS33 } [get_ports { fmc_la_n[07] }]; #IO_L20N_T3_A19_15 Sch=fmc_la_n[07]
set_property -dict {PACKAGE_PIN M13 IOSTANDARD LVCMOS33} [get_ports i_Z_MIN]
...
set_property -dict {PACKAGE_PIN G20 IOSTANDARD LVCMOS33} [get_ports o_X_EN]
#set_property -dict { PACKAGE_PIN H20   IOSTANDARD LVCMOS33 } [get_ports { fmc_la_p[09] }]; #IO_L8P_T1_AD10P_15 Sch=fmc_la_p[09]
set_property -dict {PACKAGE_PIN K22 IOSTANDARD LVCMOS33} [get_ports o_X_DIR]
set_property -dict {PACKAGE_PIN K21 IOSTANDARD LVCMOS33} [get_ports o_Z_EN]
set_property -dict {PACKAGE_PIN L15 IOSTANDARD LVCMOS33} [get_ports o_D9]
set_property -dict {PACKAGE_PIN L14 IOSTANDARD LVCMOS33} [get_ports o_X_STEP]
set_property -dict {PACKAGE_PIN L20 IOSTANDARD LVCMOS33} [get_ports o_D8]
set_property -dict {PACKAGE_PIN L19 IOSTANDARD LVCMOS33} [get_ports o_Y_EN]
#set_property -dict { PACKAGE_PIN J17   IOSTANDARD LVCMOS33 } [get_ports { fmc_la_n[13] }]; #IO_L21N_T3_DQS_A18_15 Sch=fmc_la_n[13]
set_property -dict {PACKAGE_PIN K17 IOSTANDARD LVCMOS33} [get_ports o_D10]
set_property -dict {PACKAGE_PIN H22 IOSTANDARD LVCMOS33} [get_ports o_E0_STEP]
set_property -dict {PACKAGE_PIN J22 IOSTANDARD LVCMOS33} [get_ports o_E0_DIR]
set_property -dict {PACKAGE_PIN K16 IOSTANDARD LVCMOS33} [get_ports o_Y_STEP]
set_property -dict {PACKAGE_PIN L16 IOSTANDARD LVCMOS33} [get_ports o_Z_STEP]
set_property -dict {PACKAGE_PIN G18 IOSTANDARD LVCMOS33} [get_ports o_Y_DIR]
...
set_property -dict {PACKAGE_PIN A19 IOSTANDARD LVCMOS33} [get_ports o_E0_EN]
#set_property -dict { PACKAGE_PIN A18   IOSTANDARD LVCMOS33 } [get_ports { o_E1_EN }]; #IO_L17P_T2_16 Sch=fmc_la_p[19]
set_property -dict {PACKAGE_PIN F20 IOSTANDARD LVCMOS33} [get_ports o_X_MAX]
set_property -dict {PACKAGE_PIN F19 IOSTANDARD LVCMOS33} [get_ports o_X_MIN]
#set_property -dict { PACKAGE_PIN D19   IOSTANDARD LVCMOS33 } [get_ports { i_E1_DIR }]; #IO_L14N_T2_SRCC_16 Sch=fmc_la_n[21]
set_property -dict {PACKAGE_PIN E19 IOSTANDARD LVCMOS33} [get_ports o_Z_MAX]
#set_property -dict { PACKAGE_PIN D21   IOSTANDARD LVCMOS33 } [get_ports { i_E1_STEP }]; #IO_L23N_T3_16 Sch=fmc_la_n[22]
set_property -dict {PACKAGE_PIN E21 IOSTANDARD LVCMOS33} [get_ports o_Y_MAX]
set_property -dict {PACKAGE_PIN A21 IOSTANDARD LVCMOS33} [get_ports o_Z_MIN]
set_property -dict {PACKAGE_PIN B21 IOSTANDARD LVCMOS33} [get_ports o_Y_MIN]
set_property -dict {PACKAGE_PIN B16 IOSTANDARD LVCMOS33} [get_ports i_E0_DIR]
set_property -dict {PACKAGE_PIN B15 IOSTANDARD LVCMOS33} [get_ports i_Z_DIR]
set_property -dict {PACKAGE_PIN E17 IOSTANDARD LVCMOS33} [get_ports i_E0_STEP]
set_property -dict {PACKAGE_PIN F16 IOSTANDARD LVCMOS33} [get_ports i_Y_STEP]
set_property -dict {PACKAGE_PIN E18 IOSTANDARD LVCMOS33} [get_ports i_Y_DIR]
set_property -dict {PACKAGE_PIN F18 IOSTANDARD LVCMOS33} [get_ports i_E0_EN]
set_property -dict {PACKAGE_PIN A20 IOSTANDARD LVCMOS33} [get_ports i_Z_STEP]
#set_property -dict { PACKAGE_PIN B20   IOSTANDARD LVCMOS33 } [get_ports { i_E1_EN }]; #IO_L16P_T2_16 Sch=fmc_la_p[27]
set_property -dict {PACKAGE_PIN B13 IOSTANDARD LVCMOS33} [get_ports i_X_STEP]
set_property -dict {PACKAGE_PIN C13 IOSTANDARD LVCMOS33} [get_ports i_D9]
set_property -dict {PACKAGE_PIN C15 IOSTANDARD LVCMOS33} [get_ports i_D8]
set_property -dict {PACKAGE_PIN C14 IOSTANDARD LVCMOS33} [get_ports i_D10]
set_property -dict {PACKAGE_PIN A14 IOSTANDARD LVCMOS33} [get_ports i_Z_EN]
set_property -dict {PACKAGE_PIN A13 IOSTANDARD LVCMOS33} [get_ports i_X_EN]
set_property -dict {PACKAGE_PIN E14 IOSTANDARD LVCMOS33} [get_ports i_Y_EN]
set_property -dict {PACKAGE_PIN E13 IOSTANDARD LVCMOS33} [get_ports i_X_DIR]
set_property -dict {PACKAGE_PIN A16 IOSTANDARD LVCMOS33} [get_ports i_UART_RX]
set_property -dict {PACKAGE_PIN A15 IOSTANDARD LVCMOS33} [get_ports i_UART_TX]
#set_property -dict { PACKAGE_PIN F14   IOSTANDARD LVCMOS33 } [get_ports { o_UART_TX }]; #IO_L1N_T0_16 Sch=fmc_la_n[33]
#set_property -dict {PACKAGE_PIN F13 IOSTANDARD LVCMOS33} [get_ports o_UART_RX]
